  ...
  const fetchData = async (page = 1) => {
    try {
      ...
      const response = await axios.post(
        'http://192.168.60.216:8000/api/v1/user/absensi/index',
        { page },
        {
          headers: {
            Authorization:
              'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..QHcdKwr3jXM8IHhFPyfRPlyWtyPxT_roBi64v4-idMM',
          },
        }
      );
