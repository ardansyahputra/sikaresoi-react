...
const TambahPersentaseCapaian = ({navigation}) => {
  ...
  const submitTambah = async () => {
    try {
      await apiClient.post('/setting_persentase_capaian/create', {
        bulan_id: pickBulanOptions,
        tahun_id: pickTahunOptions,
        name: pickJabatanOptions,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        ...
        />
        <Text style={styles.modalLabel}>Max Persentase Capaian</Text>
        <TextInput
          style={styles.modalInput}
...
export default TambahPersentaseCapaian;
