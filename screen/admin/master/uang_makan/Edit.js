        ...
        {isLoading ? (
          ...
          <ScrollView
            ...
            <TextInput
              ...
              value={editData?.golongan || ''} // Gunakan optional chaining `?.`
              onChangeText={text =>
                setEditData(prev => ({...prev, golongan: text}))
              }
              placeholderTextColor="#B0B0B0"
              onFocus={() => handleFocus('golongan')}
              onBlur={() => handleBlur('golongan')}
            />
            ...
            <TextInput
              style={[
                GlobalStyle.SemiBold,
                styles.input,
                focusState.nominal && styles.inputFocused,
                editData.nominal && styles.inputFilled,
              ]}
              placeholder="Nominal"
