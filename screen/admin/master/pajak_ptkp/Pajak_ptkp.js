...
export default function PajakPTKP() {
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      await apiClient.delete(`/pajak_ptkp/${selectedUuid}/delete`);
...
const styles = StyleSheet.create({
  ...
  nominalHeaderCell: {
    flex: 1,
    paddingRight: 30, // Padding kanan untuk jarak dari tepi
  },

  // Gaya baru untuk sel "PAJAK"
  nominalTableCell: {
    flex: 1,

    overflow: 'hidden', // Memastikan teks yang panjang tidak keluar dari sel
  },
  statusCellContainer: {
    width: 100,
  },
