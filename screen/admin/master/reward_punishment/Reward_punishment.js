...
export default function RewardPunishment() {
  ...
  const fetchData = async page => {
    try {
      setIsLoading(true);
      const response = await apiClient.post('/reward_punishment/index', {page});
  ...
  const handleEdit = uuid => {
    navigation.navigate('EditRewardPunishment', {uuid});
  };

  const handleReward = id => {
    if (!id) {
      console.error('ID tidak valid (undefined)');
      return;
    }
    console.log('Navigasi ke Reward dengan ID:', id);
    navigation.navigate('Reward', {reward_punishment_id: id});
  };
  ...
  const handleTambah = () => {
    navigation.navigate('TambahRewardPunishment');
  };

  const submitHapus = async () => {
    try {
      await apiClient.delete(`/reward_punishment/${selectedUuid}/delete`);
  ...
  const TableHeader = () => (
    <View>
      ...
      <View style={styles.tableHeader}>
        ...
        <Text style={[styles.headerCell, styles.nameCell]}>Bulan</Text>
        <Text style={[styles.headerCell, styles.tableStatusCell]}>Tahun</Text>
          ...
          <View style={styles.expandedContent}>
            ...
            <View style={styles.actionContainer}>
              <TouchableOpacity
                ...
                <Text style={styles.customFont}>Reward</Text>
              </TouchableOpacity>
              <TouchableOpacity
