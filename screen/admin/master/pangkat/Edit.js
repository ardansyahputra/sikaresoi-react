...
const EditPangkat = ({navigation, route}) => {
      ...
      <View style={styles.container}>
        {isLoading ? (
          ...
          <ScrollView
            ...
            <Text style={[GlobalStyle.SemiBold, styles.label]}>Pangkat</Text>
            <TextInput
              style={[
                GlobalStyle.SemiBold,
                styles.input,
                focusState.nm_pangkat && styles.inputFocused,
                editData.nm_pangkat && styles.inputFilled,
              ]}
              placeholder="Pangkat"
              ...
              onFocus={() => handleFocus('nm_pangkat')}
              onBlur={() => handleBlur('nm_pangkat')}
            />

            <Text style={[GlobalStyle.SemiBold, styles.label]}>Golongan</Text>
            <TextInput
              style={[
                GlobalStyle.SemiBold,
                styles.input,
                focusState.golongan && styles.inputFocused,
                editData.golongan && styles.inputFilled,
              ]}
              ...
              placeholderTextColor="#B0B0B0"
              onFocus={() => handleFocus('editData.golongan')}
              onBlur={() => handleBlur('editData.golongan')}
            />
            ...
            <TextInput
              style={[
                GlobalStyle.SemiBold,
                styles.input,
                focusState.ruang && styles.inputFocused,
                editData.ruang && styles.inputFilled,
              ]}
              placeholder="Ruang"
              ...
              placeholderTextColor="#B0B0B0"
              onFocus={() => handleFocus('editData.ruang')}
              onBlur={() => handleBlur('editData.ruang')}
            />
