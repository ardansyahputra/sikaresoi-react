...
const TambahPangkat = ({navigation}) => {
          ...
          <ScrollView
            ...
            <TextInput
              style={[
                ...
                styles.input,
                focusState.selectedNamaPangkat && styles.inputFocused,
                selectedNamaPangkat && styles.inputFilled,
              ]}
              ...
              onFocus={() => handleFocus('selectedNamaPangkat')}
              onBlur={() => handleBlur('selectedNamaPangkat')}
            />
            ...
            />
            <Text style={[GlobalStyle.SemiBold, styles.label]}>Ruang</Text>
            <TextInput
              style={[
                GlobalStyle.SemiBold,
                styles.input,
                focusState.selectedRuang && styles.inputFocused,
                selectedRuang && styles.inputFilled,
              ]}
              placeholder="Ruang"
              multiline
              value={selectedRuang}
              ...
              placeholderTextColor="#B0B0B0"
              onFocus={() => handleFocus('selectedRuang')}
              onBlur={() => handleBlur('selectedRuang')}
            />
