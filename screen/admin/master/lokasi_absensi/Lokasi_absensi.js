...
export default function LokasiAbsensi() {
  ...
  const fetchData = async page => {
    try {
      ...
      const response = await axios.post(
        'http://192.168.60.123:8000/api/v1/lokasiabsensi/index',
        {page},
        {
          headers: {
            Authorization: token,
  ...
  const submitEdit = async () => {
    try {
      await axios.post(
        `http://192.168.60.123:8000/api/v1/lokasiabsensi/${editData.uuid}/update`,
        {
          name: editData.name,
          lat: editData.lat,
          long: editData.long,
  ...
  const fetchEditData = async uuid => {
    try {
      const response = await axios.get(
        `http://192.168.60.123:8000/api/v1/lokasiabsensi/${uuid}/edit`,
        {
          headers: {
            Authorization: token,
          },
  ...
  const submitHapus = async () => {
    try {
      await axios.delete(
        `http://192.168.60.123:8000/api/v1/lokasiabsensi/${selectedUuid}/delete`,
        {
          headers: {
            Authorization: token,
          },
  ...
  const submitTambah = async () => {
    try {
      await axios.post(
        'http://192.168.60.123:8000/api/v1/lokasiabsensi/create',
        {
          name: selectedLokasi,
  ...
  const TableHeader = () => (
    <View>
      ...
      <View style={styles.tableHeader}>
        ...
        <Text style={[styles.headerCell, styles.nameCell]}>Nama Lokasi</Text>
        <Text style={[styles.headerCell, styles.tableStatusCell]}>Radius</Text>
        ...
        {isExpanded && (
          <View style={styles.expandedContent}>
            <Text style={styles.expandedText}>
              Nama Lokasi: {item.name || '-'}
            </Text>
            <Text style={styles.expandedText}>Latitude: {item.lat || '-'}</Text>
            <Text style={styles.expandedText}>
              Longtitude: {item.long || '-'}
            </Text>
            <Text style={styles.expandedText}>
              Radius: {item.radius || '-'}
            </Text>
      ...
      <Modal
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalLabel}>Nama Lokasi</Text>
            <TextInput
            ...
            <TextInput
              ...
              keyboardType="numeric"
            />
            <Text style={styles.modalLabel}>Radius (M)</Text>
            <TextInput
              style={styles.modalInput}
              placeholder="Radius"
              value={
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TextInput
              ...
              keyboardType="numeric"
            />
            <Text style={styles.modalLabel}>Longtitude</Text>
            <TextInput
              style={styles.modalInput}
              placeholder="Longtitude"
              multiline
              ...
              keyboardType="numeric"
            />
            <Text style={styles.modalLabel}>Radius</Text>
            <TextInput
              style={styles.modalInput}
              placeholder="Radius"
              multiline
