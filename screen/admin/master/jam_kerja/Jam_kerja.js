...
apiClient
  ...
  const handleInputChange = (text, id, field) => {
    ...
    const settingIndex = updatedSettingTimes.findIndex(setting => setting.id === id);
  ...
  const save = () => {
    ...
    const updatedSetting = settingTimes.find(setting => setting.id === activeId); // Temukan data berdasarkan ID
    ...
    return settingTimes.map((setting) => (
      <View style={styles.tableRow} key={setting.id}>
        ...
        <TextInput
          ...
          onChangeText={(text) => handleInputChange(text, setting.id, 'time_start')}
        />
        <TextInput
          style={styles.input}
        ...
        <TextInput
          ...
          onChangeText={(text) => handleInputChange(text, setting.id, 'total_jam')}
        />
        <TextInput
          style={styles.input}
          value={setting.dispensasi}
          placeholder="Dispensasi"
          onChangeText={(text) => handleInputChange(text, setting.id, 'dispensasi')}
        />
        <TouchableOpacity
