...
const TambahJenisPegawai = ({navigation}) => {
  ...
  return (
    <View style={styles.rootContainer}>
      <Header title="Tambah Jenis Pegawai" />
          ...
          <ScrollView
            ...
            <TextInput
              style={[
                ...
                styles.input,
                focusState.selectedJenis && styles.inputFocused,
                selectedJenis && styles.inputFilled,
              ]}
              placeholder="Jenis"
              multiline
              value={selectedJenis}
              ...
              onFocus={() => handleFocus('selectedJenis')}
              onBlur={() => handleBlur('selectedJenis')}
            />
            ...
            <TextInput
              style={[
                GlobalStyle.SemiBold,
                styles.input,
                focusState.selectedPersenBayar && styles.inputFocused,
                selectedPersenBayar && styles.inputFilled,
              ]}
              ...
              placeholderTextColor="#B0B0B0"
              onFocus={() => handleFocus('selectedPersenBayar')}
              onBlur={() => handleBlur('selectedPersenBayar')}
            />
