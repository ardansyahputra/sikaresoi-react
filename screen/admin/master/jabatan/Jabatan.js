    ...
    try {
      const response = await axios.get(
        'http://192.168.60.123:8000/api/v1/jabatan/getjabatan',
        {
          headers: {
            Authorization:
              'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..yeKEcQ3TayrCWb2bbCMTBEhhMkmG5l9enTmyRJ65Qy0',
          },
        },
      );
      setJabatanOptions(
    ...
    try {
      await axios.delete(
        `http://192.168.60.123:8000/api/v1/uang_makan/${selectedUuid}/delete`,
        {
          headers: {
            Authorization:
              'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..64cFdviCCKgQzgvWePOpaYCagsUNF9F-0wjnLkqKPCI',
          },
        },
      );
    ...
    try {
      await axios.post(
        ...
        },
        {
          headers: {
            Authorization:
              'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..yeKEcQ3TayrCWb2bbCMTBEhhMkmG5l9enTmyRJ65Qy0',  // Gantilah dengan token yang sesuai
            Accept: 'application/json',
          },
        }
      );
