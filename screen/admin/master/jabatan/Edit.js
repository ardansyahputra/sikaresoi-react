          ...
          <ScrollView
            ...
            <TextInput
              style={[
                ...
                styles.input,
                focusState.nm_jabatan && styles.inputFocused,
                editData.nm_jabatan && styles.inputFilled,
              ]}
              placeholder="Jabatan"
              ...
              onFocus={() => handleFocus('nm_jabatan')}
              onBlur={() => handleBlur('nm_jabatan')}
            />
            ...
            <TextInput
              style={[
                GlobalStyle.SemiBold,
                styles.input,
                focusState.grade && styles.inputFocused,
                editData.grade && styles.inputFilled,
              ]}
              placeholder="Grade"
            ...
            <TextInput
              style={[
                GlobalStyle.SemiBold,
                styles.input,
                focusState.jv && styles.inputFocused,
                editData.jv && styles.inputFilled,
              ]}
              ...
              placeholderTextColor="#B0B0B0"
              onFocus={() => handleFocus('jv')}
              onBlur={() => handleBlur('jv')}
            />
