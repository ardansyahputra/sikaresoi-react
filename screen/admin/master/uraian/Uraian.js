...
export default function Uraian() {
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      await apiClient.delete(`/uraian/${selectedUuid}/delete`);
          ...
          {isExpanded && (
            <View style={styles.expandedContent}>
              <Text style={[GlobalStyle.SemiBold, styles.expandedText]}>
                Nama Uraian: {item.nm_uraian || '-'}
              </Text>
              <Text style={[GlobalStyle.SemiBold, styles.expandedText]}>
                Jabatan: {item.jabatan?.nm_jabatan || '-'}
              </Text>
              <Text style={[GlobalStyle.SemiBold, styles.expandedText]}>
                Angka Kredit: {item.angka_kredit || '-'}
              </Text>
              <Text style={[GlobalStyle.SemiBold, styles.expandedText]}>
                WPT: {item.wpt || '-'}
              </Text>
                  ...
                  <View style={styles.modalContainer}>
                    <Text style={[GlobalStyle.SemiBold, styles.modalText]}>
                      {selectedAction === 'hapus'
                        ? 'Apakah Anda yakin ingin menghapus uraian ini?'
