...
const PotonganlainTambah = ({navigation}) => {
  ...
  const fetchNames = async () => {
    setIsLoading(false);
    try {
      const response = await apiClient.get('/user_master/show');
  ...
  return (
    <View style={styles.rootContainer}>
      <Header title="Tambah Potongan lainn" />
...
export default PotonganlainTambah;
